...
# It's better to use an environment variable for the secret key in production
...
# Database
# For Vercel, you might want to use a PostgreSQL database
# You'll need to set up the DATABASE_URL environment variable in Vercel
